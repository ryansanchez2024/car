...
//   } else {
//     Serial.println("Arducam Mega initialization failed!");
//     // You can choose to halt the program or proceed with limited functionality
//     while (true) {
//       delay(1000);  // Halt here for debugging
//     }
//   }
...
//     size_t bytesToRead =
//         (imgLen - bytesSent) > bufferSize ? bufferSize : (imgLen - bytesSent);
...
// ArduCAM_Mini_5MP_Plus and use Arduino IDE 1.6.8 compiler or above
#include <ArduCAM.h>
#include <SPI.h>
#include <Wire.h>
    ...
    while (1) {
      ...
      if (myCAM.get_bit(ARDUCHIP_TRIG, CAP_DONE_MASK)) {
        ...
        while (length--) {
          ...
          if ((temp == 0xD9) &&
              (temp_last == 0xFF))  // If find the end ,break while,
            break;
